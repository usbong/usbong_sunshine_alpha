...
import usbong.android.sunshine.alpha.R;
...
public class UsbongUtils {		
	...
	public static String DEFAULT_UTREE_TO_LOAD="sunshine"; //updated by Mike, 20160511
	public static String BASE_FILE_PATH = Environment.getExternalStorageDirectory()+"/usbong_sunshine/";
